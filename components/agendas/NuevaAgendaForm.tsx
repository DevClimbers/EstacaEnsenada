  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <Label htmlFor="hora_inicio">Hora inicio <span className="text-gray-400 text-xs">(opcional)</span></Label>
          <Input
            id="hora_inicio"
            type="time"
            value={horaInicio}
        ...
        <div className="space-y-1.5">
          <Label htmlFor="hora_fin">Hora fin <span className="text-gray-400 text-xs">(opcional)</span></Label>
          <Input
            id="hora_fin"
            type="time"
            value={horaFin}
